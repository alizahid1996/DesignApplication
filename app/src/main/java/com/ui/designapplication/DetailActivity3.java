...
import com.ui.designapplication.databinding.ActivityDetail3Binding;
...
public class DetailActivity3 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private double latitude = 37.5527;
    private double longtitude = -77.44737;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding =ActivityDetail3Binding.inflate(getLayoutInflater());
        ...
        ShowDialog(DetailActivity3.this);
    ...
    private void DataFetching() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DetailActivity3.this, error.toString(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
            ...
            if (requestCode == CAMERA_PERMISSION_CODE) {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(DetailActivity3.this, "Camera permission granted", Toast.LENGTH_LONG).show();
                    Intent cameraIntent = new Intent(android.provider.MediaStore.ACTION_IMAGE_CAPTURE);
                    startActivityForResult(cameraIntent, CAMERA_IMAGE_CODE);
                } else {
                    Toast.makeText(DetailActivity3.this, "Camera permission denied", Toast.LENGTH_LONG).show();
                }
            }
        }
